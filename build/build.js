    ...
    nextQuestion: function() {
      ...
      if (this.enableNextQuestion()) {
        ...
        if (this.currentQuestionIndex === this.questions.length) {
          return document.title = "作为一个程序猿我的身价是￥" + this.totalPrice + "，来测测你的身价是多少！";
        }
      }
    },
